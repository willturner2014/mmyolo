# --------------------------------------- 01 ---------------------------------------
#  D:\Codes\Python\AI\4_Baseline\openmmlab\mmyolo-0.5.0\configs\yolov8\yolov8_s_syncbn_fast_8xb16-500e_coco.py
...
type=dataset_type,
classes=classes,
ann_file='data/rip_gd/annotations/train.json'),
val=dict(
type=dataset_type,
classes=classes,
ann_file='data/rip_gd/annotations/val.json'),
test=dict(
type=dataset_type,
classes=classes,
ann_file='data/rip_gd/annotations/test.json'))
...
train_num_workers = 4  # Worker to pre-fetch data for each single GPU during training,suggest nGPU x 4
...
# base_lr = 0.01  # Base learning rate for optim_wrapper. Corresponding to 8xb16=64 bs
base_lr = 0.005  # Base learning rate for optim_wrapper. Corresponding to 8xb16=64 bs
max_epochs = 60  # Maximum training epochs
close_mosaic_epochs = 10  # Disable mosaic augmentation for final 10 epochs (stage 2)
...
loss_dfl_weight = 1.5 / 4   # Since the dfloss is implemented differently in the official and mmdet, we're going to divide loss_weight by 4.
lr_factor = 0.01  # Learning rate scaling factor
weight_decay = 0.0005
save_epoch_intervals = 10   # Save model checkpoint and validation intervals in stage 1
val_interval_stage2 = 1 # validation intervals in stage 2
max_keep_ckpts = 2      # The maximum checkpoints to keep.
env_cfg = dict(cudnn_benchmark=True) # Single-scale training is recommended to be turned on, which can speed up training.
...
# --------------------------------------- 02 yolov8_m---------------------------------------
# D:\Codes\Python\AI\4_Baseline\openmmlab\mmyolo-0.5.0\configs\yolov8\yolov8_m_syncbn_fast_8xb16-500e_coco.py
...
# --------------------------------------- 03 yolov8_l ---------------------------------------
# D:\Codes\Python\AI\4_Baseline\openmmlab\mmyolo-0.5.0\configs\yolov8\yolov8_l_syncbn_fast_8xb16-500e_coco.py
...
# code below about dict is correct only in derived modes
# model = dict(
#     backbone=dict(
#         last_stage_out_channels=last_stage_out_channels,
#         deepen_factor=deepen_factor,
...
# --------------------------------------- 04 yolov8_x---------------------------------------
# D:\Codes\Python\AI\4_Baseline\openmmlab\mmyolo-0.5.0\configs\yolov8\yolov8_x_syncbn_fast_8xb16-500e_coco.py
