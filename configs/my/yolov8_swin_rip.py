...
data_root = 'E:/Data/Research/Rip/video/'  # Root path of data
...
norm_cfg = dict(type='BN', requires_grad=True)  # Normalization config
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='E:/Download/swin_tiny_patch4_window7_224.pth')
        # plugins=[
        #     dict(
        #         cfg=dict(
        #             type='CBAM',
...
# ------- Dataloader = Dataset + Data Pipeline
...
test_pipeline = [
    ...
    # 这里将 LetterResize 修改成 mmdet.Resize ; Add by gaoxu 20240118
...
#                   dict(type='WandbVisBackend', init_kwargs=dict(name="YoloV8_Swin_Rip", project='rip-currents'))],
#     name='visualizer')
