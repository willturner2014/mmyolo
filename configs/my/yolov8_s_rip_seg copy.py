...
# -----data related-----
data_root = 'data/rip/rip_seg/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train.json'
train_data_prefix = 'train/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/train.json'
val_data_prefix = 'train/'  # Prefix of val image path
...
visualizer = dict(
    ...
    vis_backends=[dict(type='LocalVisBackend'),
                  dict(type='WandbVisBackend',init_kwargs=dict(name="YoloV8_S_Rip_Seg",project='rip-currents'))],
    name='visualizer')